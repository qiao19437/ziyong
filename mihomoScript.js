...
const regionDefinitions = [
  ...
  },
  {
    name: '韩国',
    flag: '🇰🇷',
    regex: /🇰🇷|韩国|首尔|釜山|春川|(?<![A-Za-z])KO?R(?![A-Za-z])|korea|seoul/i,
...
const groupBaseOption = {
  interval: 120, // 120 秒测速刷新一次
  timeout: 3000,
  url: 'https://www.apple.com/library/test/success.html', // HTTPS Apple 测速地址
  lazy: true,
  'max-failed-times': 3,
